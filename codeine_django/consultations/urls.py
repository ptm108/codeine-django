...
urlpatterns = [
    ...
    path('consultations/<slug:pk>/confirm', views_consultation.confirm_consultation_slot, name='Confirm a slot for consultation'),
    path('consultations/<slug:pk>/reject', views_consultation.reject_consultation_slot, name='Reject slot for consultation')]
