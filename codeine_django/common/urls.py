...
urlpatterns = [
    ...
    path('contentProviders/<slug:pk>/updateConsultationRate', views_content_provider.cocontent_provider_update_consultation_ratentent, name='Content provider edit consultation rate'),
