...
class Notification(models.Model):
    ...
    receiver = models.ForeignKey(
        BaseUser, related_name='received_notifications', on_delete=models.SET_NULL, blank=True, null=True)
    sender = models.ForeignKey(
        BaseUser, related_name='sent_notifications', on_delete=models.SET_NULL, blank=True, null=True)
